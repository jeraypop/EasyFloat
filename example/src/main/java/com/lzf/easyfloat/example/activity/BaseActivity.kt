...
//        WindowCompat.setDecorFitsSystemWindows(window, false)
        // 1) 开启 edge-to-edge，并自定义系统栏样式
//        enableEdgeToEdge(
//            statusBarStyle = SystemBarStyle.dark(scrim = Color.RED), // 深色背景 -> 亮色图标
//            navigationBarStyle = SystemBarStyle.light(
//                scrim = Color.WHITE,     // 浅色背景 -> 深色图标
//                darkScrim = Color.BLACK  // 供对比度使用的深色遮罩
//            )
//        )
        // 注意：用了 enableEdgeToEdge() 就不要再手动 setDecorFitsSystemWindows(false) 了，
        // 它内部已经帮你处理了透明/遮罩/icon 对比度等细节。:contentReference[oaicite:2]{index=2}
