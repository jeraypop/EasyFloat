...
import com.lzf.easyfloat.example.databinding.FloatBorderTestBinding
    ...
    private fun showBorderTest() {
        EasyFloat.with(this)
            ...
            .setLayout(R.layout.float_border_test) {
                val floatBinding = FloatBorderTestBinding.bind(it)
                val ivLogo = floatBinding.ivLogo
                val ivLogo2 = floatBinding.ivLogo2
